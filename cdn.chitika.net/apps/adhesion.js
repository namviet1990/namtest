window.CHITIKA_ADHESION = window.CHITIKA_ADHESION ? window.CHITIKA_ADHESION : (function() {
    ...
    var adhesion_config     = [
        { // 0: Desktop
            ...
            'close_config'      : {
                'height'        : '14px',
                'background'    : 'url(//images.chitika.net/buttons/close_round_white_on_red.png)',
                'right'         : '4px',
                'top'           : '5px',
                'width'         : '16px'
            },
    ...
    function adhesion_hide() {
        ...
        top.document.cookie = "http://scripts.chitika.net/eminimalls/ch_adhesion_first_load=1; expires=0; path=/";
